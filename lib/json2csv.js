...
function checkParams(params) {
  ...
  //#check delimiter
  console.log("delimeter params = ", params.del);
...
function createColumnTitles(params) {
  var str = '';
  console.log("createColumnTitles() : ", params);
  //if CSV has column title, then create it
  if (params.hasCSVColumnTitle) {
    console.log("-------");
    console.log("params.fieldNames= ", params.fieldNames);
    console.log("---");
    params.fieldNames.forEach(function (element) {
      console.log("loop forEach : ", element);
      if (str !== '') {
        str += params.del;
      }
